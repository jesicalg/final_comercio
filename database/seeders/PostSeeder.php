    ...
    public function run(): void
    {
        DB::table('posts')->insert([
            [
                ...
                'picture' => '20240405172729_mejora-en-la-velocidad-y-rendimiento.jpg',
                'category_id' => 1,
                'created_at' => now(),
                'updated_at' => now()
            ],
            [
                ...
                'picture' => '20240405173942_descuento-especial-de-lanzamiento.jpg',
                'category_id' => 2,
                'created_at' => now(),
                'updated_at' => now()
            ],
            [
                ...
                'picture' => '20240405174331_nuevas-caracteristicas-avanzadas-disponibles.jpg',
                'category_id' => 1,
                'created_at' => now(),
                'updated_at' => now()
            ],
            [
                ...
                'title' => 'Novedades',
                'picture' => '20240405200349_novedades.png',
                'category_id' => 1,
                'created_at' => now(),
                'updated_at' => now()
            ],
            [
                ...
                'picture' => '20240405202246_garantia-de-tiempo-de-actividad-del-999.png',
                'category_id' => 2,
                'created_at' => now(),
                'updated_at' => now()
            ]
