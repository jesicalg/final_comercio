...
<div>
    ...
    <h2 class="text-3xl font-bold my-6 text-center md:text-left md:ps-6">Editar Email</h2>
    <form class="flex flex-col items-start"  action="{{route('auth.processUpdateEmail', ['id' => auth()->user()->user_id])}}" method="POST" enctype="multipart/form-data">
        @csrf
